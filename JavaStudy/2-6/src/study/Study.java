...
public class Study {
    ...
    public static void main(String args[]) {
        ...
        // その理由をコメントへ記述してください。
        // Calendarクラスでは1月から12月を実際の数より-1の0~11の整数で定義されており、正しく表示するためにprintの+1で調整する。
        //ただし11月の三ヶ月後を表示するために +1 +3 で実装すると、年の繰り上げに対応していないため「14月」と表示されてしまう。その場合はcal.addのメソッドを用いる。
